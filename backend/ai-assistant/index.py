...
- chart_type НЕ NULL только если пользователь ЯВНО просит график, диаграмму, визуализацию (слова: "график", "диаграмма", "нарисуй", "покажи графиком", "визуализируй")
- Если явный запрос на график: рейтинг/сравнение → "bar", по датам → "line", доли → "pie"
- Во всех остальных случаях chart_type=null

Верни строго JSON без markdown:
{{"sql": "SELECT ...", "answer": "Краткий ответ на русском", "chart_type": null}}
