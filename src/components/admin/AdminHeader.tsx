      ...
      <div className="md:hidden mb-6 rounded-2xl overflow-hidden shadow-lg" style={{background: 'linear-gradient(135deg, #0f1f3d 0%, #1a3a6b 50%, #0d2d5a 100%)'}}>
        <div className="px-4 py-3 flex items-center justify-between">
          <div>
              ...
              <div style={{fontFamily: 'Raleway, sans-serif', fontWeight: 400, fontSize: 11, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.05em', lineHeight: 1.6}}>рекламное агентство, а не хуйня какая-то</div>
          </div>
      ...
      <div className="hidden md:block mb-8 rounded-2xl overflow-hidden shadow-xl" style={{background: 'linear-gradient(135deg, #0f1f3d 0%, #1a3a6b 50%, #0d2d5a 100%)'}}>
        <div className="px-8 py-6 flex items-center justify-between">
          <div>
            ...
            <div style={{fontFamily: 'Raleway, sans-serif', fontWeight: 400, fontSize: 13, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.05em', marginTop: 5}}>рекламное агентство, а не хуйня какая-то</div>
          </div>
