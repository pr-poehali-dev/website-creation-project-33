  ...
  return (
    <div className="flex gap-1">
      {digits.map((digit, index) => (
        <div
          key={index}
          className={`relative w-10 h-12 bg-gradient-to-b from-gray-800 to-gray-900 rounded shadow-lg overflow-hidden transition-transform duration-300 ${
            isFlipping ? 'scale-105' : 'scale-100'
          }`}
        >
          <div
            className={`absolute inset-0 flex items-center justify-center text-2xl font-bold text-white transition-all duration-300 ${
