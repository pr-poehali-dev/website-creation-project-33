    ...
    <Card className="glass-panel border-white/10 rounded-2xl slide-up hover:shadow-2xl transition-all duration-300">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {/* Контакты */}
          <div className="text-center p-4 md:p-6 rounded-xl bg-white/5 border-2 border-green-400/30 transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          {/* Подходы */}
          <div className="text-center p-4 md:p-6 rounded-xl bg-white/5 border-2 border-orange-400/30 transition-all duration-300 hover:shadow-lg hover:scale-105">
