...
export default function ShiftTableHeader({
  ...
  return (
    <thead>
      <tr className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 text-slate-100 border-b border-slate-700/50">
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <div className="flex flex-col">
            ...
            <div className="flex gap-2 text-[10px] font-normal text-slate-300">
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          ...
          <div className="text-emerald-400 font-bold mt-1">{stats.totalRevenue.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <PaymentTypeHeader
            label="Оплата"
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Налог 7%</div>
          <div className="text-red-400 font-bold mt-1">{stats.totalTax.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>После налога</div>
          <div className="text-cyan-400 font-bold mt-1">{stats.totalAfterTax.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-left whitespace-nowrap">
          <MultiSelectHeader
            label="Промоутер"
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Контакты</div>
          <div className="text-cyan-400 font-bold mt-1">{stats.totalContacts}</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Зарплата</div>
          <div className="text-orange-400 font-bold mt-1">{stats.totalSalary.toLocaleString('ru-RU')} ₽</div>
          <div className="text-red-400 font-bold mt-1 text-[10px]">Долг: {stats.unpaidSalary.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <div>Внесение</div>
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap bg-emerald-500/10">
          ...
          <div className="text-emerald-400 font-bold mt-1">{stats.totalNetProfit.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap bg-cyan-500/10">
          <div>КВВ</div>
          <div className="text-cyan-400 font-bold mt-1">{stats.totalKVV.toLocaleString('ru-RU')} ₽</div>
        </th>
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          ...
          />
          <div className="text-red-400 font-bold mt-1 text-[10px]">Общий долг: {(stats.unpaidSalaryCashless + stats.unpaidSalaryCash + stats.salaryAtKVV).toLocaleString('ru-RU')} ₽</div>
          <div className="text-red-400 font-bold mt-1 text-[10px]">Долг б/нал: {stats.unpaidSalaryCashless.toLocaleString('ru-RU')} ₽</div>
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          ...
          />
          <div className="text-red-400 font-bold mt-1 text-[10px]">Долг б/нал: {stats.unpaidKMSCashless.toLocaleString('ru-RU')} ₽</div>
          <div className="text-red-400 font-bold mt-0.5 text-[10px]">Долг нал: {stats.unpaidKMSCash.toLocaleString('ru-RU')} ₽</div>
        </th>
