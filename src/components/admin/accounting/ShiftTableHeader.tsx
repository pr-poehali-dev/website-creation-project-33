  ...
  return (
    <thead>
      <tr className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 text-slate-100 border-b border-slate-700/50 text-[10px] md:text-xs">
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Налог 7%</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalTax.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>После налога</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalAfterTax.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-left whitespace-nowrap">
          <MultiSelectHeader
            label="Промоутер"
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Контакты</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalContacts}</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap">
          <div>Зарплата</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalSalary.toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Долг: {stats.unpaidSalary.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <div>Внесение</div>
        ...
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap bg-emerald-500/10">
          ...
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalNetProfit.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap bg-cyan-500/10">
          <div>КВВ</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalKVV.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-right whitespace-nowrap bg-purple-500/10">
          <div>КМС</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-xs">{stats.totalKMS.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <FilterableHeader 
            label="Опл. орг." 
          ...
          />
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Ожидаем: {stats.expectedRevenue.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <FilterableHeader 
            label="Опл. испол." 
          ...
          />
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Общий долг: {(stats.unpaidSalaryCashless + stats.unpaidSalaryCash + stats.salaryAtKVV).toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Долг б/нал: {stats.unpaidSalaryCashless.toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 text-[9px] md:text-[10px]">Долг нал: {stats.unpaidSalaryCash.toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">У КВВ: {stats.salaryAtKVV.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <FilterableHeader 
            label="Опл. КВВ" 
          ...
          />
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Долг б/нал: {stats.unpaidKVVCashless.toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 text-[9px] md:text-[10px]">Долг нал: {stats.unpaidKVVCash.toLocaleString('ru-RU')} ₽</div>
        </th>
        <th className="border border-slate-700/50 p-1 md:p-2 text-center whitespace-nowrap">
          <FilterableHeader 
            label="Опл. КМС" 
          ...
          />
          <div className="text-white font-bold mt-0.5 md:mt-1 text-[9px] md:text-[10px]">Долг б/нал: {stats.unpaidKMSCashless.toLocaleString('ru-RU')} ₽</div>
          <div className="text-white font-bold mt-0.5 text-[9px] md:text-[10px]">Долг нал: {stats.unpaidKMSCash.toLocaleString('ru-RU')} ₽</div>
        </th>
