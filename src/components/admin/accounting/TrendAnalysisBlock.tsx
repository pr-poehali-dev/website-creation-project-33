        ...
        <div className="flex-1">
          ...
          <div className={`grid grid-cols-1 ${(period === 'month' || period === 'week') ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-3 mt-3`}>
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-lg p-3 shadow-lg border border-slate-700/50">
              ...
              <div className="text-lg font-bold text-slate-100">{formatCurrency(trendAnalysis.avgRevenue)} ₽</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-lg p-3 shadow-lg border border-slate-700/50">
              ...
              <div className={`text-lg font-bold ${trendAnalysis.novemberForecast >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            {period !== 'month' && period !== 'week' && (
              <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-lg p-3 shadow-lg border border-slate-700/50">
                ...
                <div className={`text-lg font-bold ${trendAnalysis.decemberForecast >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
