...
const METRO_GRAPH: Record<string, string[]> = {
...
function getMetroDistance(from: string, to: string): number | null {
  if (from === to) return 0;
...
function extractMetroFromOrgName(orgName: string): string | null {
              ...
              {showAddForm && !newPromoter && (
                <div className="space-y-1.5">
                  ...
                  {availablePromoters.map(p => {
                    ...
                    const orgMetro = extractMetroFromOrgName(plan.organization_name);
