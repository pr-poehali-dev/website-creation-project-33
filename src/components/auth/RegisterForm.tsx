...
const MOSCOW_METRO_STATIONS = [
  ...
  'Аэропорт','Бабушкинская','Багратионовская','Баковка','Балтийская',
  'Банки','Беговая','Бежицкая','Беломорская','Белорусская (КЛ)','Белорусская (ЗЛ)',
  'Беляево','Бибирево','Библиотека им. Ленина','Битцевский парк','Борисово',
  'Боровицкая','Боровское шоссе','Братиславская','Бульвар адмирала Ушакова',
  'Бульвар Дмитрия Донского','Бульвар Рокоссовского','Бунинская аллея',
  'Бутово','Бутырская','Варшавская','ВДНХ','Верхние Котлы','Верхние Лихоборы',
  'Владыкино','Волгоградский проспект','Волжская','Волоколамская','Воробьёвы горы',
  'Выставочная','Выхино','Говорово','Горки','Горьковская (МЦК)','Давыдково',
  'Деловой центр (АПЛ)','Деловой центр (БКЛ)','Дмитровская','Добрынинская',
  'Домодедовская','Донской бульвар','Достоевская','Дубровка','Дубровка (МЦК)',
  'Дунайская','Жулебино','Зорге','Зябликово','Измайловская','Измайлово',
  'Калужская','Каховская','Каширская (КЛ)','Каширская (ЗЛ)','Киевская (АПЛ)',
  'Киевская (КЛ)','Киевская (ФЛ)','Китай-город','Кленовый бульвар','Кожуховская',
  'Коломенская','Коммунарка','Комсомольская (КЛ)','Комсомольская (СЛ)','Коньково',
  ...
  'Крылатское','Крымская','Кузнецкий мост','Кузьминки','Кунцевская (АПЛ)',
  'Кунцевская (ФЛ)','Курская (КЛ)','Курская (ЦЛ)','Кутузовская','Ленинский проспект',
  'Лесопарковая','Лихоборы','Локомотив','Ломоносовский проспект','Лубянка',
  'Лужники','Лухмановская','Люблино','Марксистская','Марьина роща',
  'Марьино','Маяковская','Медведково','Менделеевская','Минская','Митино',
  'Мичуринский проспект','Молодёжная','Мичуринский проспект (БКЛ)','Москва-Сити',
  'Мытищи','Нагатинская','Нагатинский затон','Нагорная','Нахимовский проспект',
  'Некрасовка','Нижегородская','Нижние Мнёвники','Новогиреево','Новокосино',
  'Новокузнецкая','Новослободская','Новохохловская','Новоясеневская','Новые Черёмушки',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await register(email, password, fullName, selectedSeniorId !== '' ? selectedSeniorId : undefined, nearestMetro || undefined);
    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-3">
          ...
          {/* Ближайшее метро */}
          <div className="space-y-2">
            <Label htmlFor="metro" className="text-[#001f54] font-medium text-sm md:text-base">
              Ближайшее метро
            </Label>
            <div className="relative">
              <Icon name="MapPin" size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 z-10" />
              <select
                id="metro"
                value={nearestMetro}
