...
const HELP_TOPICS = [
  {
    ...
    answer: 'УСЛОВИЯ РАБОТЫ В ОРГАНИЗАЦИИ:\n\n🎓 СТАЖИРОВКА:\n1. Стажировка длится 3 смены.\n2. В период стажировки контакты оплачиваются по 260 рублей за контакт.\n\n💰 СИСТЕМА ОПЛАТЫ ПОСЛЕ СТАЖИРОВКИ:\n3. До 10 контактов — оплата составляет 200 рублей за контакт.\n4. 10 контактов и более — оплата составляет 300 рублей за контакт.\n\n📅 ГРАФИК РАБОТЫ:\n5. Промоутер обязан заполнять график смен в личном кабинете каждое воскресенье до 18:00. Минимальное количество смен в неделю — 3 (три).\n\n⚠️ ШТРАФНЫЕ САНКЦИИ:\n6. Невыход на смену без уважительной причины влечет за собой штраф в размере 3000 (трех тысяч) рублей.\n7. В случае невыхода на смену по причине болезни предоставляется освобождение от работы на семь календарных дней.\n\n💵 ВЫПЛАТА ЗАРАБОТНОЙ ПЛАТЫ:\n8. Заработная плата выплачивается один раз в неделю, в пятницу, на общем собрании промоутеров.'
  }
];
