...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    answer: 'Перейдите в раздел "Работа" на главном экране. Там вы увидите два блока:\n\n📝 Блокнот - здесь вы записываете информацию о клиенте.\n\n⭐ Контроль качества - ПЕРЕД подходом к клиенту нажмите кнопку со звездочкой. Звездочка начнёт крутиться - это значит, что вы работаете с клиентом.\n\n❌ Если клиент отказался - нажмите звездочку ещё раз (она станет жёлтой), затем нажмите снова, чтобы звездочка снова крутилась для следующего клиента.\n\n✅ Если клиент согласился - нажмите звездочку ещё раз (она станет жёлтой), заполните блокнот данными клиента и нажмите кнопку "Отправить в Telegram"!'
  },
  {
    id: 'schedule',
