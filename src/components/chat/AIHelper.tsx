...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    answer: 'Перейдите в раздел "Работа" на главном экране. Там вы увидите список лидов с их статусами. Нажмите на лид, чтобы увидеть детали. Вы можете изменить статус лида, добавить комментарий или связаться с клиентом.'
  },
  {
    id: 'schedule',
